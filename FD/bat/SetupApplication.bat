...
:: Android packaging
set AND_CERT_NAME="exBarcode"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exBarcode.p12
...
set IOS_PROVISION=cert\comdoitflashexBarcode.mobileprovision
...
set APP_ID=com.doitflash.exBarcode

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exBarcode
